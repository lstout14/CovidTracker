...
def update_graph(ECO, color, slider_range, whitefirst, blackfirst, whitesecond):
    elo_min, elo_max = slider_range
    
    #Pieces captured
    #fig2 = px.bar(new_df, x='piece_type', y='capture_count', color='captured_piece_type')
    ...
    fig3 = openings_by_elo(data, eco=ECO, min_elo=elo_min, max_elo=elo_max)
