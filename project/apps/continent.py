...
layout = html.Div([
    dbc.Container([
        dbc.Row([
        dbc.Col(html.H1(children='COVID-19'), className="mb-2")
        ]),
        dbc.Row([
            dbc.Col(html.H6(children='COVID-19'), className="mb-4")]),
...
#******************************************************************************************************************        
    ...
    dbc.Row([
        dbc.Col(dbc.Card(html.H3(children='Winning player trends vs ELO differentials',
