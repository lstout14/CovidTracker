...
def pieces_captured(df):
    return px.bar(df, x='piece_type', y='capture_count', color='captured_piece_type', labels={"piece_type": "Capturing Piece", "capture_count" : "Number of Pieces Captured", "captured_piece_type" : "Piece Type"})